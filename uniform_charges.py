...
use FMM to find electric field at 1000 uniformly randomly distributed target points in a 1m x 1m area on the xy plane
...
scatter = ax.scatter(targets[0], targets[1], c=mag_e_field, cmap='viridis')
